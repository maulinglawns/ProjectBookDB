...
CREATE TABLE `books` (
  ...
  `qty` int(11) NOT NULL,
  PRIMARY KEY (`uniqID`),
  FULLTEXT KEY `auth` (`auth`,`title`,`descr`)
...
-- Dump completed on 2017-01-24 13:33:42
